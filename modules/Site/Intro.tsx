  ...
  return (
    <div className="px-6 py-24 sm:py-32 lg:px-8">
      <div className="mx-auto max-w-2xl text-center">
        ...
        <IntroText text="Welcome to my personal space on the web. I'm a Software Developer and Full-Stack Engineer with a passion for creating and building things." />
      </div>
