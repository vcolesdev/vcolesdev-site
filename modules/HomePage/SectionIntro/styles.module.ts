...
export default {
  ...
  title: classNames(["mt-2", "text-4xl", "font-bold", "tracking-tight", "sm:text-6xl", "dark:text-charcoal-900"]),
  text: {
    styles: classNames(["mt-6", "text-xl", "leading-8", "text-rosy_brown-200/70", "dark:text-charcoal-700/90"]),
    content: classNames(["mx-auto", "max-w-2xl", "text-center"]),
  },
  image: {
    styles: classNames(["rounded-md", "shadow-2xl", "ring-1", "ring-gray-900/10"]),
